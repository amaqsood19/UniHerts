...
public class FacebookNews extends ListActivity {
    ...
    private class GetPosts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                url = "https://graph.facebook.com/uniofherts/posts?fields=message,full_picture,name,description,picture,link&limit=5&access_token=" + URLEncoder.encode("1399663470355158|8Nx8Zr1m2-Url9K7k7yXXB398xA", "UTF-8");
