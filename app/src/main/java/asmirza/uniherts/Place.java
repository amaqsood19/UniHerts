...
public class Place {
    ...
    public Place(Double lat, Double lang, String name, float zoom, String info, MarkerOptions marker) {
        this.lat = lat;
        this.lang = lang;
        this.name = name;
        this.zoom = zoom;
    ...
    public Place(Double lat, Double lang, String name, float zoom, String info) {
        this.lat = lat;
        this.lang = lang;
        this.name = name;
        this.zoom = zoom;
