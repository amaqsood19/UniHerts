...
public class CardService extends HostApduService {
    ...
    private static final String STUDENT_CARD_AID = "F222222222";
    ...
    private static final byte[] SELECT_APDU = BuildSelectApdu(STUDENT_CARD_AID);
    ...
    public byte[] processCommandApdu(byte[] commandApdu, Bundle extras) {
        ...
        if (Arrays.equals(SELECT_APDU, commandApdu)) {
            String studentNumber = StudentNumber.GetStudentNumber(this);
            byte[] accountBytes = studentNumber.getBytes();
            Log.i(TAG, "Sending student number: " + studentNumber);
